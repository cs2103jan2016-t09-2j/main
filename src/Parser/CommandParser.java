...
public class CommandParser {
	...
	public static int findIndexNumber(String taskDetails, Command thisCommand) throws Exception {
		...
		if (commandType.equals(COMMAND_TYPE.COMPLETE_TASK) || commandType.equals(COMMAND_TYPE.COMPLETE_TASK)) {
	...
	/**
	 * This method is used to check if the corresponding command types require an 
	 * attached task information.
	 * 
	 * @param commandType
	 * @return true, if the command type requires task information
	 * 		   false, otherwise 
	 * Only add and modify functionalities require task details.
	 */
